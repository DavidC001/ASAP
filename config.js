...
const REPLAN_MOVE_INTERVAL = (USE_PDDL) ? Math.Infinity : 5; // Number of moves before hard replanning
const SOFT_REPLAN_INTERVAL = (USE_PDDL) ? 3 : Math.Infinity; // Number of moves before soft replanning
...
const MAX_REQUEST_TIME = 4000; // Maximum time to wait for a response from the other agent
const MAX_AWAIT_RETRY = 40; // Maximum number of retries to wait for a request from the other agent
